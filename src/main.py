...
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QProgressBar, QListWidget, QLineEdit, QHBoxLayout, QLabel, QMainWindow, QShortcut, QMessageBox, QInputDialog, QFileDialog
from PyQt5.QtWebEngineWidgets import QWebEngineView, QWebEnginePage, QWebEngineScript, QWebEngineProfile, QWebEngineSettings, QWebEngineDownloadItem
